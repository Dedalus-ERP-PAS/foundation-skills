...
5. Save the presentation using `pptx.writeFile('presentation.pptx')`
...
1. **MANDATORY - READ ENTIRE FILE**: Read [`ooxml.md`](ooxml.md) completely first for XML reference.

2. **Copy the template to a working file**
   Create a working copy of the template to modify: `cp template.pptx working.pptx`
...
4. **Rearrange slides based on content requirements**
   ...
   - Slides can be duplicated (e.g., `12,12` uses slide 12 twice)
